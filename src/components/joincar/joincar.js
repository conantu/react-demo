        ...
        <div className={style.joincar}>
            ...
            <div className={style['good_b']}>
                ...
                <div className={style.size}>
                    ...
                    <div className={style.sizetype}  onClick={this.choose.bind(this,style.typeactive)}>
                ...
                <div className={style.color}>
                    ...
                    <div className={style.colortype} onClick={this.choose.bind(this,style.coloractive)}>
